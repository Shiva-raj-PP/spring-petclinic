...
public abstract class AbstractClinicServiceTests {
    ...
    public void shouldFindVets() {
        ...
        assertThat(vet.getSpecialties().get(0).getName()).isEqualTo("dentistryhjjbjhbjhvjhvj");
        assertThat(vet.getSpecialties().get(1).getName()).isEqualTo("surgerynvnbvnbvnbnbbn");
    }
